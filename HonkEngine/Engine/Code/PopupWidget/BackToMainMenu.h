...
public:
	...
	BackToMenu() : Interface("BackToMenu") {
		...
		Text* QuestionText = new Text("QuestionText", "Are you sure you want to go back to Main Menu?  Your progress will not be saved.", "Assets/Fonts/OverpassMono-SemiBold.ttf", true);
