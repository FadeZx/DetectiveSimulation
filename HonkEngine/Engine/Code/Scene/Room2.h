...
public:
    Room2() :audioManager(AudioManager::GetInstance()) {
        ...
        GameObject* background1 = new RenderGameObject("BG1", "Assets/Images/Martha/Cabin_Background.png");
        GameObject* background2 = new RenderGameObject("BG2", "Assets/Images/Martha/Cabin_Background.png");
        ...
        dialogueManager->SetChoiceScale(0.57f);
